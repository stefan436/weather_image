...
import { meta_path, indexLevels } from "./config.js";
import { getLocation } from "./geoService.js";
import { fetchMetaData } from "./dataFetcher.js";
...
map.on("click", (e) => {
  ...
  console.log(
    `Kürzeste Distanz zur Konfigurations-Palette: ${minDistance.toFixed(1)} (Zugeordnet: ≥ ${closestLevel?.min})`,
  );
